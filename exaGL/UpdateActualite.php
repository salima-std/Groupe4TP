            ...
            <div id="page-inner" style="border-radius: 30px">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs" >
                        <li class="active" ><a href="#Actualite" data-toggle="tab">Actualité</a>
                        </li>
                        <li class=""><a href="#liste" data-toggle="tab">Liste</a>
                    </ul>

                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="Actualite">
                            <br />
                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php
                                                                ...
                                                                $ID=$_GET['ID_ACTUALITE'];
                                                                $sql1='select * from actualite where ID_ACTUALITE='.$ID;
                                                                $stmt=$connect->query($sql1) ;
                                                                while ($rs = $stmt->fetch()) 
                                                                {
                                                            echo '
                                                        <label >Code</label>
                                                        <input value="'.$rs['ID_ACTUALITE'].'" name="txt_code_act1" class="form-control" style="border-radius: 30px" 
                                                            placeholder="Code à obtenir du système " />
                                                    </div>
                                                    <hr />
                                                    <div class="form-group">
                                                        <label >Désignation*</label>
                                                        <textarea value="'.$rs['DESIGNATION_ACTUALITE'].'" name="txt_desig_act1" class="form-control" style="border-radius: 30px"
                                                            placeholder="Saisissez l actualité">'.$rs['DESIGNATION_ACTUALITE'].'</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label >Lien</label>
                                                        <input value="'. $rs['LIEN'].'"  name="txt_lien_act1" class="form-control" style="border-radius: 30px" placeholder="Coller le lien de l actualité" />
                                                    </div>';
                                                        }?>
                                                </div>  
                                                <div class="col-md-3"></div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-7">
                                                    <div style="color: white;padding: 5px 0px 5px 40px;font-size: 16px;" class="col-md-12"> &nbsp;
                                                        <button value="Modifier" name="bntModifierAct"  type="submit" style="border-radius: 20px;float: right;" class="btn btn-danger">Modifier</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <br />
