    ...
    <div id="" style="width: 100%; background:#02428B;" >
        ...
        <div id="page-wrapper">
            <div id="page-inner" style="border-radius: 30px">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="main-text" style="color: red">Conseil</h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-6">
                                    <div class="panel panel-default" style="border-radius: 30px">
                                        ...
                                        <form role="form"  action="php/addConseil" method="POST" >
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php 
                                                            ...
                                                            $sql='SELECT * FROM conseil_voyageur WHERE ID_CONSEIL='.$_GET['ID_CONSEIL'];
                                                            $stmt=$connect->query($sql);
                                                            while($rs=$stmt->fetch()){
                                                        ?>
                                                        <label>Code</label>
                                                        <input value="<?php echo $rs['ID_CONSEIL']; ?>" name="txt_code_cons" class="form-control" style="border-radius: 30px"
                                                            placeholder="Code à obtenir du système " />
                                                    </div>
                                                    <hr />
                                                    <div class="form-group">
                                                        <label>Désignation*</label>
                                                        <textarea value="<?php echo $rs['DESIGNATION_CONSEIL']; ?>" name="txt_designation_cons" class="form-control" style="border-radius: 30px"
                                                            placeholder="Saisissez l'actualité"><?php echo $rs['DESIGNATION_CONSEIL']; ?></textarea>
                                                    </div> 
                                                    <div class="form-group">
                                                        <label>Lien*</label>
                                                        <input value="<?php echo $rs['LIEN'];}?>" name="txt_lien_cons" class="form-control" style="border-radius: 30px"
                                                            placeholder="Coller le lien de l'actualité" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3"></div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-7">
                                                    <div style="color: white;padding: 5px 0px 5px 40px;font-size: 16px;" class="col-md-12"> &nbsp;
                                                        <button value="Modifier" name="btnEnregistrerCons" type="submit" style="border-radius: 20px;float: right;" class="btn btn-danger">Modifier</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <br />
                                            ...
                                            <table class="table table-striped table-bordered table-hover"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            try{
                                                            include('php/connexion.php');
                                                            $sql="select * from conseil_voyageur ORDER BY PRIORITE DESC";
                                                            $stmt=$connect->query($sql) ;
                                                            while ($rs = $stmt->fetch()) 
                                                            {
                                                        echo'
                                                        <tr class="even gradeA">
                                                            <td>'. $rs['ID_CONSEIL']. '</td>
                                                            <td>'. $rs['DESIGNATION_CONSEIL'].'</td>
                                                            <td>'. $rs['LIEN'].'</td>
                                                            <td>'. $rs['DATE_CONSEIL'].'</td>
                                                            <td>'. $rs['AGENT_ID'].'</td>
                                                            <td>'. $rs['PRIORITE'].'</td>
                                                            <td class="text-center"><a href="php/PrioriteConseil.php?ID_CONSEIL='. $rs['ID_CONSEIL'].'"><img src="assets/img/LINE_24px.png"></a></td>
                                                            <td class="text-center"><a href="UpdateConseil?ID_CONSEIL='. $rs['ID_CONSEIL'].'"><img src="assets/img/Edit_24px.png"></a></td>
                                                            <td class="text-center"><a href="php/addConseil?ID_CONSEIL='. $rs['ID_CONSEIL'].'"><img src="assets/img/Trash Can_24px.png"></a></td>
                                                        </tr>';  
