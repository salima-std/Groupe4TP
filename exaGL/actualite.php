                ...
                <div class="panel-body">
                    ...
                    <div class="tab-content">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea  name="txt_desig_act" class="form-control" style="border-radius: 30px"
                                                            placeholder="Saisissez l'actualité"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label >Lien</label>
                                                        <input name="txt_lien_act" class="form-control" style="border-radius: 30px" 
                        ...
                        <div class="tab-pane fade" id="liste">
                            <form method="post" action="php/addActualite">
                            <br />
                            <div class="row">
                                <div class="col-md-12 col-sm-6">
                                    <div class="panel panel-default" style="border-radius: 30px">
