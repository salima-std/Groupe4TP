    ...
    <div id="" style="width: 100%; background:#02428B;" >
        ...
        <div id="page-wrapper">
            <div id="page-inner" style="border-radius: 30px">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="main-text" style="color: red">Protection</h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#Protection" data-toggle="tab">Protection</a>
                        </li>
                        <li class=""><a href="#liste" data-toggle="tab">Liste</a>
                    </ul>

                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="Protection">
                            <br />
                            <div class="row">
                                <div class="col-md-12 col-sm-6">
                                    <div class="panel panel-default" style="border-radius: 30px">
                                        ...
                                        <form role="form" action="php/addProtection" method="POST">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php 
                                                                ...
                                                                $sql1='select * from protegez_vous WHERE ID_PROTEGEZ_VOUS='.$_GET['ID_PROTEGEZ_VOUS'];
                                                                ...
                                                                while ($rs = $stmt->fetch()) 
                                                                {
                                                                   ...
                                                                   ?>
                                                                   <label>Code</label>
                                                                        <input value="<?php echo $rs['ID_PROTEGEZ_VOUS'];?>" name="txt_code_pro" class="form-control" style="border-radius: 30px"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea value="<?php echo $rs['DESIGNATION_PROTEGEZ_VOUS'];?>" name="txt_designation_pro" class="form-control" style="border-radius: 30px"
                                                                            placeholder="Saisissez l'actualité"><?php echo $rs['DESIGNATION_PROTEGEZ_VOUS'];?></textarea>
                                                                    </div>
                                                                   <?php
                                                                         }
                                                                    ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-7">
                                                    <div style="color: white;padding: 5px 0px 5px 40px;font-size: 16px;" class="col-md-12"> &nbsp;
                                                        <button value="Modifier" name="btnEnregistrerProt" type="submit" style="border-radius: 20px;float: right;" class="btn btn-danger">Modifier</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <br />
                        ...
                        <div class="tab-pane fade" id="liste">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-6">
                                    <div class="panel panel-default" style="border-radius: 30px">
                                        <div class="panel-heading" style="border-radius: 30px">Liste des protections</div>
                                        <div class="panel-body">
                                            ...
                                            <table class="table table-striped table-bordered table-hover"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            try{
                                                            include('php/connexion.php');
                                                            $sql="select * from protegez_vous ORDER BY PRIORITE DESC";
                                                            $stmt=$connect->query($sql) ;
                                                            while ($rs = $stmt->fetch()) 
                                                            {
                                                        echo'
                                                        <tr class="even gradeA">
                                                            <td>'. $rs['ID_PROTEGEZ_VOUS']. '</td>
                                                            <td>'. $rs['DESIGNATION_PROTEGEZ_VOUS'].'</td>
                                                            <td>'. $rs['DATE_PROTEGEZ_VOUS'].'</td>
                                                            <td>'. $rs['AGENT_ID'].'</td>
                                                            <td>'. $rs['PRIORITE'].'</td>
                                                            <td class="text-center"><a href="php/PrioriteProtection.php?ID_PROTEGEZ_VOUS='. $rs['ID_PROTEGEZ_VOUS'].'"><img src="assets/img/LINE_24px.png"></a></td>
                                                            <td class="text-center"><a href="UpdateProtection?ID_PROTEGEZ_VOUS='. $rs['ID_PROTEGEZ_VOUS'].'"><img src="assets/img/Edit_24px.png"></a></td>
                                                            <td class="text-center"><a href="php/addProtection?ID_PROTEGEZ_VOUS='. $rs['ID_PROTEGEZ_VOUS'].'"><img src="assets/img/Trash Can_24px.png"></a></td>
                                                        </tr>';  
