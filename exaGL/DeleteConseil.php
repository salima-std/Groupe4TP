            ...
            <div id="page-inner" style="border-radius: 30px">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        <li class=""><a href="#Province" data-toggle="tab">Province</a>
                        </li>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input  name="txt_designation_cons" class="form-control" style="border-radius: 30px"
                                                            placeholder="Saisissez l'actualité" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Lien*</label>
                                                        <input name="txt_lien_cons" class="form-control" style="border-radius: 30px"
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-7">
                                                    <div style="color: white;padding: 5px 0px 5px 40px;font-size: 16px;" class="col-md-12"> &nbsp;
                                                        <button value="Enregistrer" name="btnEnregistrerCons" type="submit" style="border-radius: 20px;float: right;" class="btn btn-danger">Enregistrer</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <br />
                                            ...
                                            <table class="table table-striped table-bordered table-hover"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="even gradeA">
                                                            ...
                                                            <td>'. $rs['AGENT_ID'].'</td>
                                                            <td>'. $rs['PRIORITE'].'</td>
                                                            <td class="text-center"><a href="php/PrioriteConseil?ID_CONSEIL='. $rs['ID_CONSEIL'].'"><img src="assets/img/LINE_24px.png"></a></td>
