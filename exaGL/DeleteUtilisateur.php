                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="txt_identifiant_us" type="password" class="form-control" style="border-radius: 30px"
                                            ...
                                            <table class="table table-striped table-bordered table-hover"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="even gradeA">
                                                            ...
                                                            <td>'. $rs['ACCES'].'</td>
                                                            <td class="text-center"><a href="UpdateUtilisateur?ID_AGENT='. $rs['ID_AGENT'].'"><img src="assets/img/Edit_24px.png"></a></td>
